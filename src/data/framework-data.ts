...
export const frameworkData = {
  data: [
    ...
    },
    {
      ...
      "NIST RMF": "Map 2.1",
      SOC2: null,
      "Key control activities": "- Before data acquisition, the Data Steward completes the Data Quality Assessment form to verify relevance, representativeness, and statistical suitability\n- Monthly, the Data Quality Analyst runs the Data Quality Monitoring scripts and documents results in the Data Quality Report\n- Quarterly, the AI Ethics Officer conducts bias detection tests using the Bias Detection Framework and documents findings\n- For each training dataset update, the Data Engineer verifies data provenance using the Data Lineage Verification Checklist\n- Annually, the Data Governance Committee reviews data governance policies against regulatory requirements and updates as needed",
      "Required Evidence": "- Completed Data Quality Assessment forms for all datasets used in AI systems (PDF format)\n- Monthly Data Quality Reports showing data validation results (PDF format)\n- Quarterly Bias Detection Test results with mitigation actions (PDF format)\n- Data Lineage Documentation showing clear provenance for all datasets (Excel format)\n- Data Processing Records showing transformation and validation steps (System logs)\n- Dataset bias assessment reports with mitigation strategies (PDF format)\n- Geographic and behavioral representation analysis for training datasets (Excel format)\n- Data validation test results showing statistical suitability (PDF format)",
    ...
    },
    {
      ...
      "Required Evidence": "- System Requirements Specifications with stakeholder sign-off (PDF format)\n- System Architecture Documents with Security and Privacy review notes (PDF format)\n- Technical Implementation Review reports from each development milestone (PDF format)\n- Pre-Deployment Validation Checklist with sign-off from required stakeholders (PDF format)\n- Development decision logs documenting key implementation choices (Excel format)\n- System decommissioning plans for end-of-life systems (Word documents)\n- Test case documentation and results for system validation (PDF format)\n- Quarterly AI Governance Committee review reports (PDF format)",
      "Control test plan and procedures": "1 Select two AI systems developed in the past year and verify that all lifecycle documentation exists:\n   - Requirements Specification\n   - Architecture Document\n   - Technical Implementation Reviews\n   - Pre-Deployment Validation\n2 For each selected system, verify that Security and Privacy reviews were conducted and documented\n3 Review one system's complete development history to confirm all required approvals were obtained at each phase\n4 For a system currently in development, verify active documentation is being maintained according to procedures\n5 Control passes if complete lifecycle documentation exists with appropriate approvals; fails if documentation is incomplete or approvals missing\n6 If failure, the AI Project Manager must develop a remediation plan within 5 business days and implement corrections within 20 business days"
    },
    {
      Domain: "System, Data and Model Lifecycle",
      Master: "LC-3",
      ...
      "Control test plan and procedures": "1 Review the AI Resource Inventory to verify it includes all required resource categories\n2 Select two AI systems and verify that resource dependencies are accurately documented\n3 Review the last three monthly Resource Utilization Reports to confirm regular monitoring occurs\n4 For one new AI project, verify the Resource Requirements Assessment was completed before project initiation\n5 Select five employees involved in AI development and verify current Competency Assessments exist\n6 Control passes if resource management documentation is complete and up-to-date; fails if documentation is incomplete or outdated\n7 If failure, the Resource Manager must update all affected documentation within 15 business days and implement process improvements to prevent recurrence"
    },
    {
      Domain: "System, Data and Model Lifecycle",
      Master: "LC-4",
      ...
      "Control test plan and procedures": "1 Select two AI systems and verify complete Technical Documentation Packages exist for the current version\n2 For each selected system, verify documentation includes:\n   - System characteristics\n   - Design specifications\n   - Validation results\n   - Operational logs\n3 Review system logs from the past 30 days to confirm automated logging is functioning properly\n4 For one system that underwent changes in the past quarter, verify the System Specification Document was updated appropriately\n5 Control passes if technical documentation is complete, accurate, and up-to-date; fails if documentation is incomplete, inaccurate, or outdated\n6 If failure, the Documentation Manager must implement corrections within 10 business days and review all system documentation to identify similar issues"
    },
    {
      Domain: "System, Data and Model Lifecycle",
      Master: "LC-5",
      ...
      "Control test plan and procedures": "1 Select five system changes from the past quarter and verify for each:\n   - Properly completed Change Request Form exists\n   - Change Advisory Board approval was obtained\n   - Testing was conducted and documented\n   - Post-implementation verification was performed\n2 Review the version control system to confirm proper versioning of models, datasets, and code\n3 Examine documentation to verify it was updated to reflect the implemented changes\n4 Review the last two monthly Version Control Audits to confirm they were conducted properly\n5 Control passes if change management procedures are consistently followed with proper documentation; fails if procedures are inconsistently followed or inadequately documented\n6 If failure, the Change Manager must implement process improvements within 10 business days and conduct a comprehensive review of recent changes"
    },
    {
      Domain: "Security",
      Master: "SE-1",
      ...
      "Key control activities": "- Monthly, the Security Manager reviews and updates security policies and standards using the Policy Review Checklist\n- Quarterly, the Security Architecture team conducts architecture reviews of AI systems using the Security Architecture Assessment Framework\n- The Security Operations team performs continuous monitoring of security controls using automated tools and manual checks\n- Annually, the Risk Manager conducts a comprehensive security risk assessment using the Risk Assessment Methodology\n- The Incident Response team maintains and tests incident response plans quarterly using tabletop exercises",
      "Required Evidence": "- Security policies and standards with revision history (PDF format)\n- Security Architecture Assessment reports (PDF format)\n- Continuous monitoring logs and alerts (System logs)\n- Annual Security Risk Assessment reports (PDF format)\n- Incident Response Plan test results (PDF format)\n- Security metrics and KPI reports (Dashboard)\n- Third-party security assessment reports (PDF format)\n- Business continuity test results (PDF format)",
      "Control test plan and procedures": "1 Review the last three monthly policy updates to verify the Policy Review Checklist was properly completed\n2 Select two AI systems and verify Security Architecture Assessments were conducted in the past year\n3 Review continuous monitoring logs for the past 30 days to confirm:\n   - Automated monitoring tools are functioning\n   - Alerts are being investigated and resolved\n   - Manual checks are being performed as scheduled\n4 Verify the annual security risk assessment was completed and includes:\n   - All critical systems and assets\n   - Threat and vulnerability analysis\n   - Risk treatment plans\n5 Review the last two quarterly incident response tests to confirm:\n   - All key scenarios were tested\n   - Lessons learned were documented\n   - Improvements were implemented\n6 Control passes if security governance activities are consistently performed and documented; fails if activities are inconsistent or documentation is incomplete\n7 If failure, the Security Manager must implement corrective actions within 15 business days"
    },
    {
      Domain: "Security",
      Master: "SE-2",
      ...
      "Key control activities": "- Weekly, the IAM Administrator reviews access privilege reports using the Access Review Dashboard\n- Quarterly, the Department Managers review user access rights for their departments using the Access Certification Process\n- For each new hire, transfer, or termination, the HR Coordinator completes the Identity Lifecycle Form within 1 business day\n- Monthly, the Security Analyst reviews authentication logs for anomalies using the Authentication Monitoring Tool\n- Annually, the IAM Manager reviews and tests IAM policies and procedures for effectiveness",
      "Required Evidence": "- Weekly Access Privilege Review reports (PDF format)\n- Quarterly Access Certification documentation with manager approvals (PDF format)\n- Identity Lifecycle Forms for all personnel changes (PDF format)\n- Monthly Authentication Log Analysis reports (PDF format)\n- Annual IAM Policy Review documentation with test results (PDF format)\n- User provisioning and deprovisioning records (System logs)\n- Multi-factor authentication implementation documentation (PDF format)\n- Access log retention documentation (PDF format)",
      "Control test plan and procedures": "1 Select a sample of 25 access requests from the past quarter and verify:\n   - Proper approvals were obtained\n   - Access was provisioned correctly\n   - Documentation is complete\n2 Review the last three monthly access reviews to confirm:\n   - All systems were included\n   - Inappropriate access was identified and removed\n   - Reviews were properly documented\n3 Select 10 terminated employees and verify:\n   - Access was removed within 24 hours\n   - Deprovisioning was documented\n   - Access attempts after termination were logged\n4 Verify authentication mechanisms:\n   - MFA is enforced for privileged access\n   - Password policies meet standards\n   - Failed login attempts are logged and alerts generated\n5 Control passes if IAM processes are consistently followed and documented; fails if processes are inconsistent or documentation incomplete\n6 If failure, the IAM Manager must implement corrective actions within 5 business days"
    },
    {
      Domain: "Security",
      Master: "SE-3",
      ...
      "Control test plan and procedures": "1 Review code repositories to verify secure coding standards are being followed\n2 Select three recent software releases and verify:\n   - Security testing was performed at each phase\n   - Code reviews included security checks\n   - Vulnerabilities were remediated before deployment\n3 Examine secure configuration baselines to confirm:\n   - They are documented and maintained\n   - Systems comply with baselines\n   - Deviations are approved and documented\n4 Review the last three monthly vulnerability assessments to verify:\n   - All systems were scanned\n   - Critical vulnerabilities were addressed\n   - Reports were distributed to stakeholders\n5 Control passes if secure development practices are consistently followed; fails if practices are inconsistent or security controls are bypassed\n6 If failure, the Development Manager must implement corrective actions within 10 business days"
    },
    {
      Domain: "Security",
      Master: "SE-4",
    ...
    },
    {
      ...
      "NIST RMF": null,
      SOC2: "P1.1 P1.2 P1.3",
      "Key control activities": "- Privacy impact assessments for all new AI systems and major changes.\n- Regular review and updates of privacy policies and procedures.\n- Integration of privacy requirements into system development lifecycle.\n- Training for all staff on privacy principles and requirements.\n- Regular privacy governance committee meetings.\n- Documentation of privacy decisions and rationale.\n- Monitoring of special category data processing.",
      "Required Evidence": "- Privacy Impact Assessment Reports (PDF).\n- Privacy Policies and Procedures (PDF).\n- Privacy Training Records (Excel).\n- Privacy Governance Committee Minutes (PDF).\n- Privacy Decision Logs (Excel).\n- Special Category Data Processing Register (Excel).\n- Privacy Control Effectiveness Reports (PDF).\n- Privacy Resource Allocation Records (Excel).",
      "Control test plan and procedures": "- Review PIAs for all new systems in last quarter.\n- Verify privacy requirements in system specifications.\n- Check training completion for all staff.\n- Review special category data processing logs.\n- Assess effectiveness of privacy controls.\n- Verify governance committee activities.\n- Control passes if privacy is embedded in all processes; fails if any privacy requirements are bypassed.\n- For failures, Privacy Officer must implement corrective actions within 15 days."
    },
    {
      Domain: "Privacy",
      Master: "PR-2",
    ...
    },
    {
      ...
      "Control test plan and procedures": "- Review root cause analysis reports for consistency and completeness\n- Verify incident analysis methodology\n- Check adherence to incident response procedures\n- Assess effectiveness of corrective actions\n- Review post incident review documentation\n- Verify incident tracking system\n- Control passes if incident analysis is thorough and effective; fails if any critical issues are missed or corrective actions are not implemented"
    },
    {
      ...
      SOC2: "CC1.2",
      "Key control activities": "- Regular compliance assessments\n- Maintenance of compliance register\n- Monitoring of regulatory changes\n- Implementation of compliance controls\n- Documentation of compliance evidence\n- Regular communication with authorities\n- Training on compliance requirements",
      "Required Evidence": "- Compliance Register (Excel)\n- Assessment Reports (PDF)\n- Regulatory Update Logs (Excel)\n- Control Implementation Records (PDF)\n- Compliance Evidence Repository (PDF)\n- Communication Records (PDF)\n- Training Materials (PDF)\n- Audit Trail Documentation (Excel)",
      "Control test plan and procedures": "1 Review compliance register completeness\n2 Verify assessment documentation\n3 Check regulatory update process\n4 Test compliance control effectiveness\n5 Review communication records\n6 Verify training completion\n7 Control passes if compliance is maintained; fails if requirements are not met\n8 For failures, Compliance Team must address within 10 days"
    },
    {
      Domain: "Compliance & Oversight",
      Master: "CO-2",
      ...
      SOC2: "CC1.3 CC1.4",
      "Key control activities": "- Establishment of oversight committees\n- Regular governance meetings\n- Documentation of oversight decisions\n- Resource allocation reviews\n- Monitoring of oversight effectiveness\n- Regular reporting to stakeholders\n- Review of oversight mechanisms",
      "Required Evidence": "- Governance Structure Documentation (PDF)\n- Committee Meeting Minutes (PDF)\n- Decision Logs (Excel)\n- Resource Allocation Reports (Excel)\n- Effectiveness Reviews (PDF)\n- Stakeholder Reports (PDF)\n- Oversight Process Documentation (PDF)\n- Performance Metrics (Excel)",
      "Control test plan and procedures": "1 Review governance structure\n2 Verify committee activities\n3 Check decision documentation\n4 Review resource allocation\n5 Assess oversight effectiveness\n6 Verify reporting processes\n7 Control passes if oversight is effective; fails if governance gaps exist\n8 For failures, Governance Committee must correct within 20 days"
    },
    {
      Domain: "Incident Management",
      Master: "IM-1",
      ...
      SOC2: "CC7.3 CC7.4",
      "Key control activities": "- Development and maintenance of incident response plans\n- Regular incident response team training\n- Incident classification and prioritization\n- Communication protocol implementation\n- Documentation of response procedures\n- Regular testing of response capabilities\n- Updates based on lessons learned",
      "Required Evidence": "- Incident Response Plan (PDF)\n- Training Records (Excel)\n- Classification Guidelines (PDF)\n- Communication Protocols (PDF)\n- Test Exercise Reports (PDF)\n- Incident Response Team Roster (Excel)\n- Update Logs (Excel)\n- Test Scenario Documentation (PDF)",
      "Control test plan and procedures": "- Review incident response plan completeness\n- Verify team training completion\n- Test classification procedures\n- Check communication protocols\n- Review response capabilities\n- Assess documentation quality\n- Control passes if response planning is comprehensive; fails if significant gaps exist\n- For failures, Response Team must update within 15 days"
    },
    {
      Domain: "Incident Management",
      Master: "IM-2",
    ...
    },
    {
      ...
      SOC2: "CC7.3 CC7.4",
      "Key control activities": "- Conducting post-incident reviews\n- Root cause analysis execution\n- Implementation of improvements\n- Documentation of lessons learned\n- Communication of findings\n- Tracking of improvement actions\n- Regular review of incident trends",
      "Required Evidence": "- Post-Incident Review Reports (PDF)\n- Root Cause Analysis Documents (PDF)\n- Improvement Implementation Records (Excel)\n- Lessons Learned Repository (PDF)\n- Communication Records (PDF)\n- Action Tracking Logs (Excel)\n- Trend Analysis Reports (PDF)\n- Stakeholder Briefings (PDF)",
      "Control test plan and procedures": "- Review post-incident analysis process\n- Verify root cause identification\n- Check improvement implementation\n- Review lessons learned documentation\n- Verify communication effectiveness\n- Assess trend analysis\n- Control passes if analysis leads to effective improvements; fails if root causes are not addressed\n- For failures, Incident Team must revise approach within 20 days"
    }
  ] as FrameworkControl[]
}; 