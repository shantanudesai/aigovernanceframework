...
export const frameworkData = {
  data: [
    ...
    },
    {
      ...
      "Key control activities": "- Develop risk treatment plans prioritizing high-impact risks using the Risk Treatment Plan Template.\n\n- Deploy technical (e.g., encryption) and organizational (e.g., training) controls proportionate to risk levels.\n\n- Assign accountability for risk treatment to specific roles (e.g., AI Risk Officer).\n\n- Conduct quarterly risk treatment effectiveness reviews using the Risk Treatment Review Template.\n\n- For continuously learning systems, deploy automated feedback loop monitoring tools, reviewed monthly using the Feedback Loop Monitoring Protocol.\n\n- Establish a QMS aligned with ISO 9001 using the Quality Management Framework, approved by the Quality Manager.\n\n- Integrate QMS requirements into AI projects using the Quality Integration Checklist, verified at project milestones.\n\n- Conduct quarterly QMS effectiveness reviews using the Quality Review Template.\n\n- Perform annual QMS audits using the QMS Audit Protocol.\n\n- Assign QMS roles (e.g., Quality Manager) and hold semi-annual executive oversight meetings for QMS performance.",
      "Required Evidence": "- Risk Treatment Plan Templates with prioritization details (PDF format).\n\n- Control implementation documentation (e.g., system configurations, training records, PDF format).\n\n- Accountability assignment records (e.g., responsibility matrices, PDF format).\n\n- Quarterly Risk Treatment Review Template reports (PDF format).\n\n- Monthly Feedback Loop Monitoring Protocol reports, including anomaly detection logs (PDF format).\n\n- Quality Management Framework documentation (PDF format).\n\n- Quality Integration Checklists for AI projects (PDF format).\n\n- Quarterly Quality Review Template reports (PDF format).\n\n- Annual QMS Audit Protocol reports (PDF format).\n\n- QMS role assignment documentation (PDF format).\n\n- Semi-annual executive oversight meeting minutes for QMS (PDF format).\n\n- Storage: GRC system; Sample size: All documentation for the past 12 months.",
      "Control test plan and procedures": "- Select two high-impact risks and verify Risk Treatment Plan Templates exist.\n\n- Review system configurations and training records for control implementation.\n\n- Confirm accountability assignments via responsibility matrices.\n\n- Examine the last two quarterly Risk Treatment Review Template reports.\n\n- For one continuously learning system, review the last three monthly Feedback Loop Monitoring Protocol reports.\n\n- Verify the Quality Management Framework is documented and approved.\n\n- Check Quality Integration Checklists for two AI projects.\n\n- Review the last two quarterly Quality Review Template reports.\n\n- Examine the most recent annual QMS Audit Protocol report.\n\n- Confirm QMS role assignments and semi-annual executive oversight meeting minutes.\n\n- Control passes if risk treatment and QMS controls are effectively implemented; fails if significant gaps exist in either risk treatment or quality management processes."
    },
    {
      Domain: "Risk Management",
      Master: "RM-4",
    ...
    },
    {
      ...
      "NIST RMF": null,
      SOC2: "CC5.2 CC7.1",
      "Key control activities": "- Implement secure coding standards using the Secure Coding Guideline, verified before code commits.\n\n- Conduct weekly security testing, including AI-specific threat tests (e.g., model poisoning, adversarial attacks) using the AI Security Testing Framework.\n\n- Verify secure configurations for each release using the Secure Configuration Checklist.\n\n- Perform monthly vulnerability assessments, including AI-specific vulnerabilities, using the Vulnerability Management Tool.\n\n- Maintain secure development environments with restricted access, audited quarterly using the Development Environment Audit Tool.\n\n- Document change management procedures with security approvals using the Change Management Log.",
      "Required Evidence": "- Secure Coding Guideline documentation with verification records (PDF format).\n\n- Weekly AI Security Testing Framework reports, including model poisoning and adversarial attack results (PDF format).\n\n- Secure Configuration Checklists for each release (PDF format).\n\n- Monthly Vulnerability Management Tool reports, including AI-specific vulnerabilities (PDF format).\n\n- Quarterly Development Environment Audit Tool reports (PDF format).\n\n- Change Management Logs with security approvals (PDF format).\n\n- Storage: Secure repository; Sample size: All security documentation for the past 6 months.",
      "Control test plan and procedures": "- Select three recent code commits and verify adherence to Secure Coding Guidelines.\n\n- Review the last four weekly AI Security Testing Framework reports for AI-specific threat testing.\n\n- For two recent releases, verify Secure Configuration Checklists were completed.\n\n- Examine the last two monthly Vulnerability Management Tool reports for AI-specific vulnerabilities.\n\n- Review the most recent quarterly Development Environment Audit Tool report for access controls.\n\n- Verify Change Management Logs include security approvals.\n\n- Control passes if security controls are effective against both traditional and AI-specific threats; fails if significant vulnerabilities exist."
    },
    {
      Domain: "Security",
      Master: "SE-4",
    ...
    },
    {
      ...
      SOC2: "CC2.1 CC2.2",
      "Key control activities": "- Deploy real-time oversight dashboards for monitoring AI outputs, configured by the AI Operations team.\n\n- Establish human review procedures for high-risk decisions in the Oversight Procedure Manual.\n\n- Implement intervention mechanisms (e.g., manual override interfaces), tested quarterly using the Intervention Testing Protocol.\n\n- Conduct monthly oversight effectiveness reviews using the Oversight Effectiveness Checklist.\n\n- Provide annual training for oversight personnel on system behavior and intervention using the AI Oversight Training Program.\n\n- Maintain monthly intervention logs for high-risk systems.",
      "Required Evidence": "- Oversight dashboard configuration documentation (PDF format).\n\n- Oversight Procedure Manual (PDF format).\n\n- Quarterly Intervention Testing Protocol reports (PDF format).\n\n- Monthly Oversight Effectiveness Checklist reports (PDF format).\n\n- AI Oversight Training Program materials and completion records (PDF format, LMS reports).\n\n- Monthly intervention logs for high-risk systems (System logs).\n\n- Storage: GRC system; Sample size: All oversight documentation for the past 12 months.",
      "Control test plan and procedures": "- Verify oversight dashboards are operational for two AI systems.\n\n- Review the Oversight Procedure Manual for high-risk decision processes.\n\n- Test intervention mechanisms for one high-risk system using the Intervention Testing Protocol.\n\n- Examine the last three monthly Oversight Effectiveness Checklist reports.\n\n- Confirm training completion for oversight personnel via LMS records.\n\n- Review intervention logs for one high-risk system over the past three months.\n\n- Control passes if oversight mechanisms are effective and personnel are properly trained; fails if oversight gaps or training deficiencies exist."
    },
    {
      Domain: "Safe Responsible AI",
      Master: "RS-2",
    ...
    },
    {
      ...
      SOC2: "CC7.1 CC8.1",
      "Key control activities": "- Conduct weekly reliability testing using the Reliability Testing Suite.\n\n- Perform monthly adversarial testing, including AI-specific threats, using the Adversarial Testing Framework.\n\n- Execute quarterly stress testing using the Stress Testing Protocol.\n\n- Test edge cases for each system update using the Edge Case Test Suite.\n\n- For continuously learning systems, conduct monthly feedback loop testing using the Feedback Loop Testing Framework.\n\n- Perform annual resilience assessments using the Resilience Assessment Tool.",
      "Required Evidence": "- Weekly Reliability Testing Suite reports (PDF format).\n\n- Monthly Adversarial Testing Framework reports (PDF format).\n\n- Quarterly Stress Testing Protocol reports (PDF format).\n\n- Edge Case Test Suite results for system updates (PDF format).\n\n- Monthly Feedback Loop Testing Framework reports for continuously learning systems (PDF format).\n\n- Annual Resilience Assessment Tool reports (PDF format).\n\n- Storage: Testing repository; Sample size: All robustness documentation for the past 12 months.",
      "Control test plan and procedures": "- Review the last four weekly Reliability Testing Suite reports.\n\n- Examine the last two monthly Adversarial Testing Framework reports for AI-specific threats.\n\n- Verify the most recent quarterly Stress Testing Protocol report.\n\n- Confirm Edge Case Test Suite results for one recent system update.\n\n- For one continuously learning system, review the last three monthly Feedback Loop Testing Framework reports.\n\n- Check the most recent annual Resilience Assessment Tool report.\n\n- Control passes if all robustness tests demonstrate consistent system performance; fails if significant vulnerabilities or inconsistencies are identified."
    },
    {
      Domain: "Safe Responsible AI",
      Master: "RS-4",
    ...
    },
    {
      ...
      SOC2: "CC4.1",
      "Key control activities": "- Define accuracy metrics for high-risk AI systems before deployment using the Accuracy Metrics Definition Template.\n\n- Validate accuracy metrics monthly using the Accuracy Validation Protocol.\n\n- Update and disclose accuracy metrics for each system update using the Accuracy Disclosure Form.\n\n- Conduct quarterly accuracy compliance reviews using the Accuracy Compliance Checklist.\n\n- Reassess accuracy methodologies annually using the Accuracy Methodology Review Framework.",
      "Required Evidence": "- Accuracy Metrics Definition Template for each high-risk system (PDF format).\n\n- Monthly Accuracy Validation Protocol reports (PDF format).\n\n- Accuracy Disclosure Forms for system updates (PDF format).\n\n- Quarterly Accuracy Compliance Checklist reports (PDF format).\n\n- Annual Accuracy Methodology Review Framework reports (PDF format).\n\n- Accuracy metrics tracking logs (Excel format).\n\n- Storage: Compliance repository; Sample size: All accuracy documentation for the past 12 months.",
      "Control test plan and procedures": "- Verify Accuracy Metrics Definition Templates for two high-risk AI systems.\n\n- Review the last three monthly Accuracy Validation Protocol reports.\n\n- Confirm Accuracy Disclosure Forms for one recent system update.\n\n- Examine the most recent quarterly Accuracy Compliance Checklist report.\n\n- Validate accuracy metric calculations for one system output sample.\n\n- Check the most recent annual Accuracy Methodology Review Framework report.\n\n- Control passes if accuracy metrics are properly defined and monitored; fails if metrics are inadequate or not regularly validated."
    },
    {
      Domain: "Privacy",
      Master: "PR-1",
    ...
    },
    {
      ...
      SOC2: "CC4.2 CC3.1",
      "Key control activities": "- Conduct monthly controls testing using the Internal Controls Testing Framework.\n\n- Perform quarterly compliance verification using the Compliance Verification Protocol.\n\n- Validate new or significantly changed systems, including self-assessments for stand-alone high-risk systems, using the Self-Assessment Checklist.\n\n- Review audit findings semi-annually using the Audit Findings Review Template.\n\n- Engage external assessors annually for independent assessments using the External Assessment Protocol.",
      "Required Evidence": "- Monthly Internal Controls Testing Framework reports (PDF format).\n\n- Quarterly Compliance Verification Protocol reports (PDF format).\n\n- Self-Assessment Checklist reports for stand-alone high-risk systems (PDF format).\n\n- Semi-annual Audit Findings Review Template reports (PDF format).\n\n- Annual External Assessment Protocol reports (PDF format).\n\n- Certification tracking logs (Excel format).\n\n- Storage: Audit repository; Sample size: All assessment documentation for the past 12 months.",
      "Control test plan and procedures": "- Review the last three monthly Internal Controls Testing Framework reports.\n\n- Examine the most recent quarterly Compliance Verification Protocol report.\n\n- Verify Self-Assessment Checklist reports for two stand-alone high-risk systems.\n\n- Review the last semi-annual Audit Findings Review Template report.\n\n- Check the most recent annual External Assessment Protocol report.\n\n- Confirm certification status in tracking logs.\n\n- Control passes if assessments are comprehensive and certifications are current; fails if significant gaps exist or certifications are expired."
    },
    {
      Domain: "Assurance and Audit",
      Master: "AA-3",
    ...
    },
    {
      ...
      "NIST RMF": "Govern 4.3",
      SOC2: "CC7.2 CC7.3",
      "Key control activities": "- Configure logging systems to capture system usage, inputs, and outputs daily using the Event Logging Framework.\n\n- Review logs weekly for high-risk systems using the Critical System Logging Checklist.\n\n- For GPAI models, capture interaction and output details daily using the GPAI Logging Template.\n\n- Protect logs with encryption and access controls, audited quarterly using the Log Security Audit Tool.\n\n- Verify log retention compliance monthly using the Log Retention Checklist.\n\n- Test log accessibility for authorities annually using the Regulatory Access Protocol.",
      "Required Evidence": "- Event Logging Framework configuration documentation (PDF format).\n\n- Weekly Critical System Logging Checklist reports for high-risk systems (PDF format).\n\n- Daily GPAI Logging Template reports (PDF format).\n\n- Quarterly Log Security Audit Tool reports (PDF format).\n\n- Monthly Log Retention Checklist reports (PDF format).\n\n- Annual Regulatory Access Protocol test results (PDF format).\n\n- Storage: Secure logging system; Sample size: All logging documentation for the past 12 months.",
      "Control test plan and procedures": "- Verify Event Logging Framework configuration for two AI systems.\n\n- Review the last four weekly Critical System Logging Checklist reports.\n\n- Confirm daily GPAI Logging Template reports for one GPAI model over the past month.\n\n- Examine the most recent quarterly Log Security Audit Tool report.\n\n- Check the last three monthly Log Retention Checklist reports.\n\n- Test log accessibility using the Regulatory Access Protocol.\n\n- Control passes if logging systems are properly configured and maintained; fails if logs are incomplete or inaccessible."
    },
    {
      Domain: "Operational Monitoring",
      Master: "OM-3",
    ...
    },
    {
      ...
      SOC2: "CC2.2",
      "Key control activities": "- Develop transparency disclosures for AI systems before deployment using the Transparency Disclosure Template.\n\n- Conduct monthly user understanding surveys using the Transparency Feedback Survey.\n\n- Update transparency documentation for each system update using the Transparency Update Checklist.\n\n- For GPAI models, label generated outputs and disclose model capabilities using the GPAI Transparency Framework, reviewed quarterly.\n\n- Perform quarterly transparency compliance audits using the Transparency Compliance Protocol.\n\n- Ensure accessibility standards (e.g., WCAG 2.1) in transparency communications, verified annually.",
      "Required Evidence": "- Transparency Disclosure Template for each AI system (PDF format).\n\n- Monthly Transparency Feedback Survey results (PDF format).\n\n- Transparency Update Checklist for system updates (PDF format).\n\n- Quarterly GPAI Transparency Framework reports (PDF format).\n\n- Quarterly Transparency Compliance Protocol reports (PDF format).\n\n- Annual accessibility verification reports (PDF format).\n\n- Storage: Compliance repository; Sample size: All transparency documentation for the past 12 months.",
      "Control test plan and procedures": "- Verify Transparency Disclosure Templates for three AI systems.\n\n- Review the last three monthly Transparency Feedback Survey results.\n\n- Confirm Transparency Update Checklists for two recent system updates.\n\n- Examine the last two quarterly GPAI Transparency Framework reports.\n\n- Check the most recent quarterly Transparency Compliance Protocol report.\n\n- Verify accessibility compliance for one transparency communication sample.\n\n- Control passes if transparency requirements are met and properly documented; fails if disclosures are inadequate or accessibility standards are not met."
    },
    {
      Domain: "Transparency & Communication",
      Master: "CO-2",
